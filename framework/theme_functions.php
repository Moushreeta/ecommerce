...
function gostore_register_required_plugins(){
    ...
    $plugins = array(
		...
		,array(
			...
			,'source'             => 'https://downloads.wordpress.org/plugin/redux-framework.4.3.26.zip'
            ,'required'           => true
			,'version'            => '4.3.26'
            ,'external_url'       => ''
        )
		,array(
            'name'                => 'WooCommerce'
            ,'slug'               => 'woocommerce'
			,'source'             => 'https://downloads.wordpress.org/plugin/woocommerce.7.4.0.zip'
            ,'required'           => true
			,'version'            => '7.4.0'
            ,'external_url'       => ''
        )
		,array(
            'name'                => 'Elementor'
            ,'slug'               => 'elementor'
			,'source'             => 'https://downloads.wordpress.org/plugin/elementor.3.11.2.zip'
            ,'required'           => true
			,'version'            => '3.11.2'
            ,'external_url'       => ''
        )
		...
		,array(
            'name'                => 'Contact Form 7'
            ,'slug'               => 'contact-form-7'
			,'source'             => 'https://downloads.wordpress.org/plugin/contact-form-7.5.7.4.zip'
            ,'required'           => false
			,'version'            => '5.7.4'
            ,'external_url'       => ''
        )
		,array(
			...
			,'source'             => 'https://downloads.wordpress.org/plugin/mailchimp-for-wp.4.9.1.zip'
            ,'required'           => false
			,'version'            => '4.9.1'
            ,'external_url'       => ''
        )
		,array(
			...
			,'source'             => 'https://downloads.wordpress.org/plugin/yith-woocommerce-wishlist.3.18.0.zip'
            ,'required'           => false
			,'version'            => '3.18.0'
            ,'external_url'       => ''
        )
